...
It sits on top of the existing `_run_distant_game_sim()` function which already handles
...
## Key Files
- `BackEnd/api/franchise_routes.py` — `_run_distant_game_sim()` (existing, handles scores)
- `BackEnd/models/distant_game_stats.py` — New file for all functions in this document
- `BackEnd/constants/computer_game_constants.py` — Authoritative team-stat constants
- `docs/docs_1_systems/06_GMO_Supporting_Systems/Distant_Game_Sim_System.md` — System doc
