## Sim Quarter System ✅ **COMPLETE** (January 2025)
...
**Quarter Display:**
- Header shows: `Simulating Q${displayQuarter}...` where `displayQuarter = quarter - 1`
...
**Potential Additions:**
- Display other event types (steals, blocks, fouls) in scroll
