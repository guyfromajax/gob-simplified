  ...
  function buildTopGridHead() {
    ...
    if (isWeek35Mode()) {
      head.innerHTML = [
        ...
        '<th class="is-sortable" data-sort-key="rt" data-tooltip="current/potential" title="current/potential">RT</th>',
    ...
    head.innerHTML = [
      ...
      '<th>Pos</th>',
      '<th>YR</th>',
      '<th data-tooltip="current/potential" title="current/potential">RT</th>',
      '<th>Current Lean</th>',
      '<th>Adjust</th>',
      '<th>Remove</th>',
      '</tr>'
