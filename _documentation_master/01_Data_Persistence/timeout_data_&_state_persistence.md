...
**Related docs:** `Data_Persistence_System.md` (hybrid cache/DB model, timeout click clock reconciliation, fix history) · `../05_GP_Supporting_Systems/Timeout_System.md` (full timeout system: limits, popup, scoreboard immediacy) · `../05_GP_Supporting_Systems/Computer_Timeout_System.md` (CPU timeout conditions + per-quarter limit persistence)
