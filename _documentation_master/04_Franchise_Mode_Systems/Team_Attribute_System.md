...
**Scale reference (0–200, MID 100):** To change the scale, see **[Shot_Threshold_Scale_Tuning.md](../00_Operations/Shot_Threshold_Scale_Tuning.md)** (agent workflow + manual checklist).
