> 📄 **Authoritative system doc:** [06_Gameplay_Systems/Dynamic_HCO_System.md](../06_Gameplay_Systems/Dynamic_HCO_System.md) — full architecture, **Tunable Constants**, key files. This brief is build-phase scratch (rationale, phase log).
