...
**Status:** ARCHIVED 2026-09-14. All fixes shipped; canonical behavior lives in `Dynamic_HCO_System.md`, `Stopper_System.md` and `Step_By_Step_System.md`. Open verification debt moved to `Dynamic_HCO_System.md` §4 (Seam 3 re-cut, interception stale victim) and `Stopper_System.md` (pending-pass regression test, in-app DBTO confirm). The DBTO section's "unit test" was not retained in `tests/`. *(Previously: ACTIVE VERIFICATION DEBT — rechecked 2026-08-08.)*
