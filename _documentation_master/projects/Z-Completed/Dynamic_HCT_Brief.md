...
3. **Else** (no defender in range) → **uncontested FB shot** (universal uncontested inside/attack make roll via `BackEnd/utils/uncontested_shot.py`).
