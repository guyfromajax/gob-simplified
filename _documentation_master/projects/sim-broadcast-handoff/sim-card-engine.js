...
(function () {
  ...
  Engine.prototype.teamStats = function () {
    ...
    return [
      ['REBOUNDS', a.reb, h.reb, 'tug', false],
      ['TURNOVERS', a.to, h.to, 'tug', true],
      ['FAST BREAK', a.fb, h.fb, 'tug', false],
      ['PTS IN PAINT', a.paint, h.paint, 'tug', false],
      ['FG%', pct(a), pct(h), 'rate', false],
      ['3PM', a.tpm, h.tpm, 'rate', false],
      ['TEAM FOULS', a.fouls, h.fouls, 'tug', true]
    ];
  };
