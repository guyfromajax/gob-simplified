...
Fixed set, fixed order — ordered by causal chain, not convention:

| # | Stat | Treatment |
|---|---|---|
| 1 | Rebounding | tug |
| 2 | Turnovers | tug |
| 3 | Fast break points | tug |
| 4 | Points in the paint | tug |
| 5 | FG% | paired readout, no bar |
| 6 | 3PM | paired readout, no bar |
| 7 | Team fouls | tug |

- Turnovers sits directly above fast break points deliberately: TO −5 stacked on FB PTS −11 reads as a sentence nobody wrote.
- **Tug:** both absolute values shown, bar pulls toward the better team by the size of the edge. Counting stats only. Direction is per-stat — inverted for turnovers and team fouls.
- **Rates do not tug.** FG% 45 vs 42 has the same numeric gap as rebounds 13 vs 10 and means something completely different. Rates render as paired numbers flanking a centre pivot tick, leader marked by contrast.
