...
- Player-wait is **start-cpu-sims + phase-a + phase-b**, not start-cpu-sims alone. Persist-fixed season on this machine: **~6.0 hours** wall. Week 5 CPU path 259+5+31 s; week 26 975+14+240 s. phase-b 31 s → 240 s is still open.
