...
(function () {
  ...
  function updateNext() {
    ...
    if (btn) {
      ...
      else { btn.textContent = 'All caught up'; btn.setAttribute('href', '#topics'); btn.style.display = ''; }
    }
    if (cue) {
      ...
      else { cue.innerHTML = '<span class="nx-lbl">Nice work</span><span class="nx-name">Every lesson explored</span>'; cue.removeAttribute('href'); cue.style.display = ''; }
    }
  }
