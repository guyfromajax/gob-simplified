...
|---|---|---|---|
| **`equiv_v3_loose_baseline_f600628a4_agspread.json`** | `f600628a4` (2026-09-24) | `EQUIV_MAN_POSTURE=loose`, `SEED_DEFENSES=1`, both arms, n=40 | **CURRENT loose baseline.** `GOB_DEFENDER_AG_SPREAD` ON at s=0.50 on top of the loose-sag/no-gate defaults. Re-baselined on independent cells (8/8). Future loose work measures against this. |
