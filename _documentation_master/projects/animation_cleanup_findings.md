...
**Status:** Assessment complete 2026-08-27. The original brief (symptoms/references, in the user's words) is preserved as **Appendix A** at the end of this doc.
...
## Appendix A — Original brief (2026-08-27, user's words)

> Merged from `animation_cleanup_brief.md` on 2026-09-14 (doc-bloat pass). Preserved verbatim; only its
> headings were demoted. It is the "what good feels like" reference these findings answer.
