...
| [turnAnimation.js:2683-2748](../../FrontEnd/static/js/phaser/animation/turnAnimation.js#L2683-L2748) | `runOffensiveReboundKickoutSetup` picks PG/rebounder positions from `HCO_STRING_SPOTS` via `Math.random()` | confirmed | OREB Kickout PG/rebounder repositioning |
...
|---|---|---|---|
| Fast Break — After Steal | [phase_resolution.py:991-1944](../../BackEnd/engine/phase_resolution.py#L991-L1944) emits `animations[]` only; no `animation_steps` stamp when `fb_play_key == "after_steal"` | Yes (Not migrated) | Not surprising |
...
Inferred CR-shaped steps (UESS §2 note). Source: phase_resolution.py:991-1944.

| Step | Status |
|---|---|
| Step 1 (Burst / outlet receiver run) | All §3.1/§3.2 fields absent |
| Step 2 (Outcome — shot / foul / steal / dead-ball / defensive stop) | All §3.1/§3.2 fields absent |
| Step 3 (Step-back / HCO settle, defensive stop only) | All §3.1/§3.2 fields absent |
