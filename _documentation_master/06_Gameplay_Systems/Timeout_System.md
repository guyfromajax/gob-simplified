...
- **Player Momentum (MO):** a regular timeout decays each active player's MO toward 0 by `randint(2,4)` (the smaller timeout range; bench → 0). **Foul-out timeouts do NOT reset MO.** See [Player_Momentum_System.md](Player_Momentum_System.md).
