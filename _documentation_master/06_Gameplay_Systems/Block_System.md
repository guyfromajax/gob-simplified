...
**Status:** Implemented (re-verified against code June 2026; attempt roll, fight trigger, and thresholds updated to current values)  
...
- **Constants** (in `BackEnd/constants/__init__.py`): `BLOCK_RECONCILIATION_SHOOTING_FOUL_THRESHOLD` (currently **150**), `BLOCK_RECONCILIATION_BLOCK_THRESHOLD` (currently **-150**). They are **independent**: adjust one without affecting the other.
