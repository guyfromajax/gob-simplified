...
- **Community Engagement / home crowd:** `../05_GP_Supporting_Systems/Home_Crowd_System.md`; implementation `BackEnd/utils/home_crowd.py`, FTD pending in `BackEnd/api/franchise_routes.py` (`run_franchise_training` + distant training), game start in `BackEnd/api/api.py`.
